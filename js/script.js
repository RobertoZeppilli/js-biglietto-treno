...
// 3.1. Var of normal/full price
var fullPrice = ticketPrice.toFixed(2);

// 4. Var with sale on kids and over-65
var kidsTicket = (ticketPrice - ((ticketPrice * 20) / 100)).toFixed(2);
// console.log(kidsTicket);

var over65Ticket = (ticketPrice - ((ticketPrice * 40) / 100)).toFixed(2);
// console.log(over65Ticket);

// 5. Final price in relationship to specific case
if (passengerAge < 18) {
